...
def refill_distribution(dist_filename,R_aperture,Num):
    ...
    #print(Dist_return[0])
    with open(dist_filename,'w') as final_dist:
    	np.savetxt(final_dist,Dist_return)
    final_dist.close()
    return Qpass
...
#return_distribution = refill_distribution('3boosters000609_FBL_SC.0174.001',0.00025,20000)
#with open('Dist_50fC_25_refill.ini','w') as final_dist:
